...
contract OptimismBridge {
    ...
    function ownerUnlockOptimismETH(address userToBridge, uint lockedForOptimismETH) public {
        if (msg.sender != Owner) { revert notOwnerAddress(); }
        ...
        uint sendETH = lockedForOptimismETH- optimismBridgedETH[userToBridge];
